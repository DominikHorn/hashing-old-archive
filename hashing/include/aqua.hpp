...
struct AquaHash {
  ...
  * @param value
  * @param seed
  * @param select bit offset according to formula select * 32, defaults to 0
  * @return
  */
    ...
    */
   template<typename T>
   static forceinline __m128i hash128(const T& value, const __m128i seed = _mm_setzero_si128()) {
      return Hash(&value, sizeof(T), seed);
   }
